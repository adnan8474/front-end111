...
import { downloadSuspiciousCSV } from '../utils/exporter';
    ...
    <div>
      <div className="flex justify-between mb-2">
        ...
        <button
          ...
          onClick={() => downloadSuspiciousCSV(sorted, 'suspicious.csv')}
        >
          Export CSV
        </button>
      </div>
          ...
          <tbody>
            {sorted.map(row => (
              ...
              >
                ...
                <td>
                  {row.suspicious ? (
                    <span title="Threshold exceeded" className="font-bold">Yes</span>
                  ) : (
                    'No'
                  )}
                </td>
